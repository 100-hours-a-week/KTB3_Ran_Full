...
//
//    @Override
//    public Comment commentCreate(long id, long id, CommentInputDto commentInputDto){
//        Comment comment = new Comment(CommentIdGenerator.getInstance().nextId(),commentInputDto.getContent(),id,id);
//        Comments.put(comment.getCommentId(), comment);
//        return comment;
//    }
//
//    @Override
//    public Optional<List<Comment>> commentListByPostId(long id){
//        return Optional.of(Comments.values().stream().filter(it -> it.getPostId().equals(id)).toList());
//    }
//
//    @Override
